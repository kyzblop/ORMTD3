...
<body>
	<form method="post">
		...
		<input type="radio" class="btn-check" name="moyen" id="option2"
			...
			class="btn btn-secondary" for="option2">CB</label>
		...
		<div class="mb-3">
			<label class="form-label">Montant</label> <input type="number"
				class="form-control" aria-describedby="emailHelp" name="montant">
		</div>
		<div class="mb-3">
